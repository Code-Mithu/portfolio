          ...
          <section className="flex flex-wrap gap-4 pt-4 border-t border-slate-200">
            {project.demoUrl && (
              <a
                ...
                className="px-6 py-3 bg-primary text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors flex items-center gap-2"
            ...
            {project.githubUrl && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-6 py-3 bg-white border border-slate-300 text-slate-700 rounded-lg font-semibold hover:bg-slate-50 transition-colors flex items-center gap-2"
